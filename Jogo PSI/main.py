...
class personagem(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        if self.hp <= 0 or self.rect.top > janela_altura:
            self.hp = 0
            self.velocidade = 0
            self.vivo = False
    ...
    def desenhar(self):
        tela.blit(pygame.transform.flip(self.animacao[self.movimento_status][self.index], self.flip, False),
...
# ============================================== Menu Principal ========================================================
def menu_pricipal():
    global Mapa_index, Inimigos_Grupo
    ...
    while run:
        ...
        # start
        tela.blit(start_img, (start_img_rect.x, start_img_rect.y + 5))
        # opções
        tela.blit(botao_opcoes, (start_img_rect.x, start_img_rect.y + 110))

        texto("Escolha o planeta destino", 30, (0, 0, 0), janela_altura / 2 - 100, JANELA_LARGURA / 2 - 50)
        ...
        if marte_rect.collidepoint(pos):
            if pygame.mouse.get_pressed()[0] == 1:
                Mapa_index = 1
                pygame.draw.rect(tela, (126, 152, 130), (JANELA_LARGURA / 2 - 200, janela_altura / 2, 300, 60))
                texto("Marte", 50, pygame.Color("black"), JANELA_LARGURA / 2 - 50, janela_altura / 2 + 30)
                GRAVIDADE = 0.50
        ...
        if terra_rect.collidepoint(pos):
            if pygame.mouse.get_pressed()[0] == 1:
                Mapa_index = 0
                pygame.draw.rect(tela, (126, 152, 130), (JANELA_LARGURA / 2 - 200, janela_altura / 2, 300, 60))
                texto("Terra", 50, pygame.Color("black"), JANELA_LARGURA / 2 - 50, janela_altura / 2 + 30)
                GRAVIDADE = 0.75
...
# ============================================== Jogo ========================================================
def jogo():
    global Jogador, Barra_saude, lv1, screen_scroll
    ...
    Inimigo2 = personagem(1200, 30, 2, "Rato")
    Inimigo1 = personagem(1300, 30, 2, "Rato")
    Inimigos_Grupo.add(Inimigo2, Inimigo1)
    ...
    while run:
        ...
        if Jogador.vivo:
            ...
            texto("r para voltar ao menu", 30, pygame.Color("red"), janela_altura / 2, JANELA_LARGURA / 2)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if not Jogador.vivo and event.key == pygame.K_r:
                    menu_pricipal()
